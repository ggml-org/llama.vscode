...
export class Prompts {
    ...
    CHAT_GET_KEY_WORDS = "Analyze the text below and extract the most important keywords. Ensure no word is repeated in the output. Format the response strictly as:\nkeyword1|keyword2|...\n*Text: {prompt}"
