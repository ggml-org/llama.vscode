...
export class Utils {
        ...
        return new Promise((resolve) => {
            ...
            <body>
                ...
                <div class="buttons">
                    ...
                    <button class="button" onclick="respond(true)">${acceptLabel}</button>
                </div>
                <script>
                const vscode = acquireVsCodeApi();
                function respond(answer) {
        ...
        return new Promise((resolve) => {
            ...
            <body>
                ...
                <div class="buttons">
                    <button class="button secondary" onclick="respond(false, false)">No</button>
                    <button class="button secondary" onclick="respond(false, true)">No, Don't Ask Again</button>
                    <button class="button" onclick="respond(true, false)">${acceptLabel}</button>
                    <button class="button" onclick="respond(true, true)">${acceptLabel}, Don't Ask Again</button>
                </div>
                <script>
                const vscode = acquireVsCodeApi();
                function respond(answer, dontAsk) {
    ...
    static showEnvConfirmationDialog = (message: string, details: string): Promise<boolean> => {
        return new Promise((resolve) => {
            const panel = vscode.window.createWebviewPanel(
                'envConfirmation',
            ...
            <body>
                <div class="container">
                    <div class="message">${message.replace(/\n/g, '<br>')}</div>
                    <div class="details">
                        <div class="details-header">Env Details</div>
                        <div class="details-content">${details.replace(/\n/g, '<br>').replace(/: /g, ': ')}</div>
                    </div>
                </div>
                <div class="buttons">
                    <button class="button secondary" onclick="respond(false)">Cancel</button>
                    <button class="button" onclick="respond(true)">Continue</button>
                </div>
                <script>
                const vscode = acquireVsCodeApi();
                function respond(answer) {
