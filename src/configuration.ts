...
export class Configuration {
    ...
    private updateConfigs = (config: vscode.WorkspaceConfiguration) => {
        ...
        this.tool_run_terminal_command_enabled = config.get<boolean>("tool_run_terminal_command_enabled", true);
        this.tool_create_agent_enabled = config.get<boolean>("tool_create_agent_enabled", true);
        this.tool_search_source_enabled = config.get<boolean>("tool_search_source_enabled", true);
        this.tool_read_file_enabled = config.get<boolean>("tool_read_file_enabled", true);
        this.tool_list_directory_enabled = config.get<boolean>("tool_list_directory_enabled", true);
        this.tool_regex_search_enabled = config.get<boolean>("tool_regex_search_enabled", true);
        this.tool_delete_file_enabled = config.get<boolean>("tool_delete_file_enabled", true);
        this.tool_permit_some_terminal_commands = config.get<boolean>("tool_permit_some_terminal_commands", false);
        this.tool_permit_file_changes = config.get<boolean>("tool_permit_file_changes", false);
        this.tool_get_diff_enabled = config.get<boolean>("tool_get_diff_enabled", false);
        this.tool_edit_file_enabled = config.get<boolean>("tool_edit_file_enabled", true);
        this.tool_ask_user_enabled = config.get<boolean>("tool_ask_user_enabled", true);
        this.tool_custom_tool_enabled = config.get<boolean>("tool_custom_tool_enabled", false);
        this.tool_update_todo_list_enabled = config.get<boolean>("tool_update_todo_list_enabled", true);
        this.tool_delegate_task_enabled = config.get<boolean>("tool_delegate_task_enabled", true);
        this.tool_llama_vscode_help_enabled = config.get<boolean>("tool_llama_vscode_help_enabled", true);
        ...
        this.tool_custom_eval_tool_enabled = config.get<boolean>("tool_custom_eval_tool_enabled", false);
